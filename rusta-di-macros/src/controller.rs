    ...
    let registrations: Vec<TokenStream2> = handler_infos
        ...
        .map(|(idx, info)| {
            ...
            let self_ty_str = quote!(#self_ty)
                ...
                .replace("::", "_")
                .replace(' ', "");
            let factory_ident = format_ident!("__rusta_route_{}_{}_{idx}", self_ty_str, fn_name);
            ...
            quote! {
                ...
                fn #factory_ident(__container: &::rusta_di::ContainerRef) -> ::axum::routing::MethodRouter<::rusta_di::ContainerRef> {
                    #preamble
                    #with_layers
                }

                ::rusta_di::inventory::submit!(::rusta_di::RouteDescriptor {
                    method: #verb_str,
                    base_path: #base_str,
                    path: #route_str,
