//! Ravix - A modern Rust API framework built on axum.
//!
//! Ravix provides clean-architecture patterns, proc-macro route registration,
//! and InversifyJS-style dependency injection for building production-ready
//! async web services.
//!
//! # Architecture
//!
//! Ravix follows a layered architecture pattern:
...
// Re-export DI types from ravix-di
pub use ravix_di::{
