//! Dependency injection library for Rusta framework.
//!
//! This crate provides the core DI container, traits, and extractors.
//! For proc-macros (`#[injectable]`, `#[controller]`), use `rusta-di-macros`.
...
// Re-export inventory so the macro-generated `::rusta_di::inventory::submit!` works.
pub use inventory;
...
/// DI attributes, and common types without the `rusta_di::` prefix.
///
/// ```rust
/// use rusta_di::prelude::*;
/// ```
pub mod prelude {
    pub use crate::container::{Container, ContainerRef, Inject, Injectable};
    pub use crate::{
        Body, Extension, IntoResponse, Json, Next, Path, Query, Request, Response, StatusCode,
    };
}
